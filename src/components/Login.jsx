...
const Login = () => {
  ...
  return (
    ...
    <div>
        ...
        <form className="bg-black p-4  absolute w-3/12 mx-auto my-36 left-0 right-0 text-white bg-opacity-80 rounded-lg">
          ...
          <input type="text" placeholder="Email Address"  className="my-2 p-3 w-full bg-[#131517]"/>
          <input type="password" placeholder="Password" className="my-2 p-3 w-full bg-[#131517]"/>
          <button className="text-white bg-red-700 my-2 p-2 w-full rounded-lg"> {isSignInForm?"Sign In":"Sign Up"}</button>
